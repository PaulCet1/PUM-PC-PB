    ...
    private void buttonClickListener(){
        ...
        start.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0){
                Intent intentPlays = new Intent(getApplicationContext(), StepDetectorActivity.class);
                intentPlays.setFlags(Intent.FLAG_ACTIVITY_SINGLE_TOP);
                startActivity(intentPlays);
            }
        });
