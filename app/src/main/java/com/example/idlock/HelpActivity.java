...
public class HelpActivity extends AppCompatActivity {
    ...
    public String path  = Environment.getExternalStorageDirectory().getAbsolutePath() + "/idlock";
    File myDirs = new File(path);
    File file =new File(path+"/pomiarykrokow.txt");
